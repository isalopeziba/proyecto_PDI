...
**2. Carga de imágenes**
- Presiona el botón “Subir Evidencia”.
- Selecciona una imagen desde tu computadora.
- El sistema mostrará una vista previa.

**3. Procesamiento**
Una vez cargada la imagen: Haz clic en “Clasificar imagen”.
- La imagen es enviada al backend en Flask.
- El modelo en Python analiza la imagen y devuelve los resultados.
- Dependiendo del resultado verás:
    - etiquetas : Hueco; grieta, Calle Buena
    - bounding boxes para los huecos  y basura
      
**4. Resultados**
El resultado aparecerá: debajo de la imagen y en un panel lateral.
